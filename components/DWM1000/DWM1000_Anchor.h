...
public:
    ...
    ValueFlow<uint32_t> polls;
    ValueFlow<uint32_t> blinks;
    ValueFlow<uint32_t> finals;
    ValueFlow<uint32_t> errs;
    ValueFlow<uint32_t> missed;
    ValueFlow<uint32_t> timeouts;
    ValueFlow<uint32_t> interruptCount;
    ValueFlow<float> distanceRef;
